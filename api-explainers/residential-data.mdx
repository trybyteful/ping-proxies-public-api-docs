...
description: 'Understanding and managing residential data allocation in the Byteful API'
---

Unlike datacenter and ISP proxies that operate on a per-proxy model, residential proxies use a data-based allocation system. This guide explains how residential data is managed in the Byteful API.

## Data Fundamentals

Residential data in Byteful works as follows:
...
2. Click "Add Data" next to your residential data total on the summary page
