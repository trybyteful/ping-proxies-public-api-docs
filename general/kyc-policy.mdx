...
<Warning>
  **From 7 September 2026, traffic sent directly to IP addresses is blocked by default.** Customers who need access can request it by emailing [compliance@byteful.com](mailto:compliance@byteful.com). Requests are reviewed case by case and typically require KYC verification.
</Warning>
