...
<Warning>
  **From 7 September 2026, traffic sent directly to IP addresses is blocked by default.**
  ...
  If your use case requires it, you can request access by emailing [compliance@byteful.com](mailto:compliance@byteful.com) with a short explanation of what you need it for. Requests are reviewed case by case and typically require KYC verification.
</Warning>
